 ...
 * file is kept as a thin re-export so the in-folder Day Editor consumers (the day-editor
 * view-model's export gate) and their tests keep their existing import path.
 *
