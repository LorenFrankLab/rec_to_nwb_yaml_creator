...
describe('repairTargetForIssue (Repair Routing Contract)', () => {
  ...
  const DAY_CODES = [
    ...
    { code: 'duplicate_associated_file_name', step: 'epochs', issue: { code: 'duplicate_associated_file_name', path: 'associated_files[1].name', field: 'name', step: 'epochs', repairSurface: 'day' } },
    { code: 'duplicate_associated_file_path', step: 'epochs', issue: { code: 'duplicate_associated_file_path', path: 'associated_files[1].path', field: 'path', step: 'epochs', repairSurface: 'day' } },
    { code: 'statescript_description_keyword', step: 'epochs', issue: { code: 'statescript_description_keyword', path: 'associated_files[0].description', field: 'description', step: 'epochs', repairSurface: 'day', severity: 'warning' } },
    { code: 'associated_file_path_shape', step: 'epochs', issue: { code: 'associated_file_path_shape', path: 'associated_files[0].path', field: 'path', step: 'epochs', repairSurface: 'day', severity: 'warning' } },
