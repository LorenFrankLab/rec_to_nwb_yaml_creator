...
- [app-code-organization-review.md](app-code-organization-review.md) — architecture/code-organization follow-up note for domain boundaries, page/module ownership, and type drift.
