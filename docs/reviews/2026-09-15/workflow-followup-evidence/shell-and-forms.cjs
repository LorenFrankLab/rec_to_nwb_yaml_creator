...
(async () => {
  ...
  try {
    ...
    assert.equal(results.coldWorkspace.skip.position, 'absolute');
    assert.equal(results.coldWorkspace.footer.height, 24);
    ...
    assert.deepEqual(results.workspaceAfterLegacy.skip, results.coldWorkspace.skip);
    assert.deepEqual(results.workspaceAfterLegacy.footer, results.coldWorkspace.footer);
    assert.deepEqual(results.workspaceAfterLegacy.nav, results.coldWorkspace.nav);
